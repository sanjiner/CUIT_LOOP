...
$(document).ready(function(){
	...
	function submitData() {
		...
		//alert($("#imgProduce").attr("src"));
		$.ajax({
			type:"POST",
			url : "<%=basePath%>enterprise/produce/edit",
			data : {
				"id":"${produce.productId}",
...
<div style="background: #4c9ee7;width: 100%;height: 30px;margin-bottom: 5px">
	<label style="width: auto;height: 30px;text-align: center;color: white;line-height: 30px;margin-left: 5px">企业个性化管理>>产品管理>>编辑产品</label>
	</div>
		...
		<table>
				...
				<td>
					<%-- <div id="imgContainer" style="height: auto; min-height: 190px">
						<div id="divwrapper" class="wrapper" style="cursor: pointer;">
							<img id="imgProduce" src="<%=path %>${ produce.productimg}"
			...
			<tr>
				...
				<td><script id="editor" type="text/plain"
						style="width:1024px;height:500px;">${produce.productcontent}</script></td>
			</tr>
		</table>
