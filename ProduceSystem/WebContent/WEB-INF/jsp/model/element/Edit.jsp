...
<body>
		...
		<table class="info" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="value"><input id="txtName" name="txtName"
					class="width60per" value="${ elementDetail[0].elementName}" />
					<input id="txtElement" name="txtElement" type="hidden" value="${ elementDetail[0].elementNumber}" />
				</td>
			</tr>
			<tr>
				...
				<td class="value">
					...
					<script type="text/javascript">
						$("#selType").val(("${ elementDetail[0].elementType}").endsTrim());
					</script>
				</td>
			</tr>
			<tr>
				<td class="text">要素单位：</td>
				<td class="value"><input id="txtUnit" name="txtUnit"
					class="width60per" value="${ elementDetail[0].unit}" /></td>
			</tr>
			<tr>
				<td class="text">气象指标：</td>
				<td class="value"><input id="txtIndicators" name="txtIndicators"
					class="width60per" value="${ elementDetail[0].remark}" /></td>
			</tr>
			<tr>
				<td class="text">要素描述：</td>
				<td class="value">
					<textarea id="txtDecription" name="txtDecription" rows="8" cols="25">${ elementDetail[0].elementDecription}</textarea>
				</td>
			</tr>
			<tr>
				<td class="text">&nbsp;</td>
	...
	function doSubmit(){
		if(validate()){
			$.post("<%=basePath%>model/element/edit", $("#form1").serialize(), function(data){
				if(data.state=="fail"){
					alert(data.result);
				}
				else{
