...
<body>	
		...
		<div class="left_nav">
			<div>
				<ul id="tree" class="filetree">	
				 <li>
				 	<span class="folder">
							<a href="<%=basePath%>model/grade/list?parentId=0" target="modelFrame">模型类别</a>
					</span>	
					<ul>			
					<c:forEach items="${modelTypelist}" var="mtlist">
						<li>
							<span class="file">
								<a href="<%=basePath%>model/grade/list?parentId=${mtlist.cuitMoonDictionaryCode}" target="modelFrame">${mtlist.cuitMoonDictionaryName}</a>
							</span>
						</li>
					</c:forEach>
					</ul>
	...
	<div class="right_content">
		<iframe name="modelFrame"
			src="<%=basePath%>model/grade/list?parentId=0"></iframe>
	</div>
