...
<body>
	<form id="form1" method="post" action="" enctype="multipart/form-data" onsubmit="return doSubmit()">
		<table class="info" cellpadding="0" cellspacing="0">
			<tr>
				<td class="text"><span class="required">*</span>产品名称：</td>
				<td class="value"><input id="txtName" name="txtName"
					class="width60per" /></td>
			</tr>
			<tr>
				<td class="text"><span class="required">*</span>商品码：</td>
	...
	function doSubmit(){
		if(validate()){
			$.post("<%=basePath%>model/product/add", $("#form1").serialize(), function(data){
				if(data.state=="fail"){
					alert(data.result);
				}
				else{
