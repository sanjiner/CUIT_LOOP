...
<body>	
		...
		<div class="left_nav">
			<div>
				<ul id="tree" class="filetree">	
				 <li>
				 	<span class="folder">
							<a href="<%=basePath%>model/product/list?parentId=0" target="modelFrame">产品类别</a>
					</span>	
					<ul>			
					<c:forEach items="${productTypelist}" var="ptlist">
						<li>
							<span class="file">
								<a href="<%=basePath%>model/product/list?parentId=${ptlist.cuitMoonDictionaryCode}" target="modelFrame">${ptlist.cuitMoonDictionaryName}</a>
							</span>
						</li>
					</c:forEach>
					</ul>
	...
	<div class="right_content">
		<iframe name="modelFrame"
			src="<%=basePath%>model/product/list?parentId=0"></iframe>
	</div>
