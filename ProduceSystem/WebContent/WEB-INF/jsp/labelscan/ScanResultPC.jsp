...
function goEN(){
	...
	window.location.href = "<%=basePath%>labelscan/ScanResultPCEN?id="+labelId+"&lan="+languageType;
}
</script>
</head>
<body bgcolor="#cccccc" style="margin-left:15%; margin-right: 15%">
 	...
 	<br/>
 	<div><label style="font-size: x-large; font-weight: 700; background-color: #01733F; color: #FFFFFF;" >示例图片</label></div>
 	...
 	<div style="background-color: #FFFFFF"> 
 		<table>
 			...
 			<tr><td>所属商家：<a href="<%=basePath%>bussiness_center/center?id=${businessId}">${businessName}</a></td></tr>
