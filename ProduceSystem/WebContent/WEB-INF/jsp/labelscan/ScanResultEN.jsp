...
function goCH(){
	var labelId = document.getElementById("labelId").innerHTML;
	window.location.href = "<%=basePath%>labelscan/ScanResult?id="+labelId;
}
</script>
</head>
<body bgcolor="#cccccc" style="margin-left:1%; margin-right: 1%">
 	...
 	<div style="background-color: #FFFFFF"> 
 		<table>
 			...
 			<tr><td>Merchant:<a href="<%=basePath%>labelscan/CertiBusinessInfo?id=${applyPerson}">${company}</a></td></tr>
 	...
 	<div style="background-color: #FFFFFF">
 		...
 		<div>The best growing condition:</div>
