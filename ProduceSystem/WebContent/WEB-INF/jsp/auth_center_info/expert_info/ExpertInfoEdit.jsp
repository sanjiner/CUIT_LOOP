	...
	<input id = "primaryKey" type = "hidden" value ="${primaryKey}">
		<table class="info" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="value"><input type="text" id="userName" value="${userName}" class="width60per" name="Username" /></td>
			</tr>
			<tr>
				<td class="text"><span style="color: #FF0000">*</span>专家名称</td>
				<td class="value"><input type="text" id="expertname"  class="width60per" value="${expertname}" name="ExpertName" /></td>
			</tr>
			<tr>
				<td class="text">专家层次</td>
				<td class="value"><span id="expertLevel">${expertLevel}</span></td>
			</tr>
			<tr>
				<td class="text">专家类别</td>
				<td class="value">
					<c:forEach var="expertCategoryVar" items="${expertCategoryList}">
						<p><input  type="checkbox" name="ecChechbox" value="${expertCategoryVar.getCuitMoonDictionaryCode()}">${expertCategoryVar.getCuitMoonDictionaryName()}</p>
					</c:forEach>
				</td>
			</tr>
			<tr>
				...
				<td class="value">
				<input type="hidden" id="belongToMeteorology" value = "${belongToMeteorology }" />
				<span id="belongToMeteorologyName"  class="width60per">${belongToMeteorologyName}</span>
				</td>
			</tr>
			<tr>
				<td class="text">身份证号码</td>
				<td class="value"><input type="text" id="idnumber" value="${idnumber}" name="ID" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">工作单位</td>
				<td class="value"><input type="text" id="workUnits" value="${workUnits}" name="WorkUnits" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">毕业学校</td>
				<td class="value"><input type="text" id="schools" value="${schools}" name="School" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">手机号码</td>
				<td class="value"><input type="text" id="tel" value="${tel}" name="TEL" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">学历</td>
				<td class="value"><input type="text" id="educationalBackground" value="${educationalBackground}" name="Education" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">Email</td>
				<td><input type="text" id="mailBox" value="${mailBox}" name="Email" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">联系地址</td>
				<td class="value"><input type="text" id="address" value="${address}" name="Address" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">邮编</td>
				<td class="value"><input type="text" id="postCode" value="${postCode}" name="PostCode" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">QQ</td>
				<td class="value"><input type="text" id="qq" value="${qq}" name="QQ" class="width60per" /></td>
			</tr>
			<tr>
				<td class="text">照片</td>
				<td class="value"><img id="photo" style="width: 120px; height: 120px; background: #c2c2c2; cursor: pointer;" src="${photoPath }" />
					<div>
			...
			<tr>
				...
				<td class="value"><input type="text" class="width60per" id="expertIntroduction" value="${expertIntroduction}" name="ExpertIntroduction" /></td>
			</tr>
			<tr>
				<td class="text">备注信息</td>
				<td class="value"><input type="text" id="remark" value="${remark}" class="width60per" name="Remark" /></td>
			</tr>
			<tr>
				<td class="text"></td>
