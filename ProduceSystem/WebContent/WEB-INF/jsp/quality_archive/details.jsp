...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var imags = "${report.attachmentUrl}";
	...
	$(document).ready(function(){
		var imags = "${report.certificateImage}";
		var strs = imags.split("|");
		for(i = 0; i < strs.length;i++){
			if(strs[i].length <=0 )
				continue;
...
<body style="background: #edf1fc">
	...
	<div
		...
		<label
			style="margin: 10px; width: 100%; height: 30px; line-height 30px; color: white; size: +1.5"><b>品质档案报告</b></label>
	</div>
		...
		<table class="table">
			...
			<tr>
				...
				<td><%-- <img id="imgSign" src="<%=path%>${report.certificateImage }"
					width="120px" height="150px"> --%>
					<div id="imgSign" style="height: auto;min-height: 150px">
					</div></td>
			</tr>
			<tr>
				<td>认证报告：</td>
