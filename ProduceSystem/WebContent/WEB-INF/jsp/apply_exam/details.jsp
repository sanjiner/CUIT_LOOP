...
<div style="background: #4c9ee7;width: 100%;height: 30px;">
	<label style="width: auto;height: 30px;text-align: center;color: white;line-height: 30px;margin-left: 5px">应用中心>>认证审核>>审核详情</label>
	</div>
	...
	<center>
		<a type="button" class="btn_blue"
			...
			href="<%=basePath%>exam/list?requsetPageNo=${requsetPageNo}">返回</a>
	</center>
</body>
</html>