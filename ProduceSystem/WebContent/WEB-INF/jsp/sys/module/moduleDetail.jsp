...
<body>
	...
	<div class="container">
		<div>
			<form:form action="${ctx}sys/module/editModule"
				modelAttribute="module" method="post">
				<table>
					<tr>
						<td>
							模块名称
						</td>
						<td><form:hidden path="cuitMoonModuleId" /> <form:input
					...
					<tr>
						...
						<td><p>${module.cuitMoonParentModuleName }</p></td>
					</tr>
					<tr>
						<td>
							排序号
						</td>
						<td><form:input path="cuitMoonModuleOrderNum"/></td>
					</tr>
					<tr>
						<td>
							模块状态
						...
						<td><form:select path="cuitMoonModuleStatus">
								<c:choose>
									<c:when test="${module.cuitMoonModuleStatus eq 1}">
