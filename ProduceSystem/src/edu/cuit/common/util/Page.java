...
public class Page {
	private int pageIndex; // 页面索引号从 0开始
	...
	private int currentPage = 1; // 默认当前页面1，页号从1开始
	
	private int currentPageSize = 0;  //当前页面含有的数据条数

	private List<?> pageList; // 页面中存放的取出对象list集合
	...
	public Page(int pageIndex, int pageSize, int allSize, List<?> pageList) {
