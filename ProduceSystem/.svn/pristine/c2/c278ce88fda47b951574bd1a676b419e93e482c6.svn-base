...
function submitToServer(){
	if(validateInfo()){
		...
		$.ajax({
			...
			url : url,
			dataType : "html",
			data : { 'primaryKey': $("#primaryKey").val(),'stationID': $("#stationID").val(),'name': $("#name").val(),'belongTo': $("#belongTo").text(),'longitude':$("#longitude").val(),'latitude': $("#latitude").val(),'measuringelements':measuringelements,'remark':$("#remark").val()},
