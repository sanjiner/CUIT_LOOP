...
function make() {
	...
	window.location.href = "<%=basePath%>label/manage/application/makelabel?applyBh="+pid +"&labelApplicationId="+id;	 
}
function back() {
	var pid = document.getElementById('applyBh').value;
...
<div style="background: #4c9ee7;width: 100%;height: 30px;margin-bottom: 5px">
	<label style="width: auto;height: 30px;text-align: center;color: white;line-height: 30px;margin-left: 5px">认证标签管理>>标签管理>>制作标签</label>
</div>
<br/>
<form id="form1" action="<%=basePath%>label/manage/application/make" method="post">	
	<div>
	...
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="生成标签" onclick="make()" class="btn_blue" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
