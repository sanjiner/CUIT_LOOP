...
<script type="text/javascript">
	...
	function submit() {
		...
		imags+="]";
		 $.ajax({
             type: "post",
             url: "<%=basePath%>origin/edit?id=${id}",
             dataType: "html",
             /*
             text_company_name :  
				text_product_name :  
...
<div style="background: #4c9ee7;width: 100%;height: 30px;margin-bottom: 5px">
	<label style="width: auto;height: 30px;text-align: center;color: white;line-height: 30px;margin-left: 5px">农网认证>>认证申请</label>
	</div>
	<form id="form1">
				...
				<tbody>
					...
					<tr>
						...
						<td class="content_left"><input type="text"
							id="text_company_name" name="text_company_name" value="${pamodel.applyCompany }" /></td>
						<td class="text_right"><span class="required">*</span>申请人</td>
						<td class="content_left"><input type="text"
							id="text_company_person" name="text_company_person" value="${pamodel.applyPerson }"/></td>
					</tr>
					<tr>
						<td class="text_right"><span class="required">*</span>产品名称</td>
						<td class="content_left"><input type="text"
							id="text_product_name" name="text_product_name" value="${pamodel.originName }"/></td>
						<td class="text_right"><span class="required">*</span>产品品牌</td>
						<td class="content_left"><input type="text"
							id="text_product_brand" name="text_product_brand" value="${pamodel.productBrand}" /></td>
					</tr>
					<tr>
						...
						<td class="content_left"><input type="text"
							id="text_product_address" name="edit_product_address" value="${pamodel.personAdress}" /></td>
					</tr>
					<tr>
						<td class="text_right"><span class="required">*</span>产品产值</td>
						<td class="content_left"><input type="text"
							id="text_output_value" name="text_output_value" value="${pamodel.productValue}"/></td>
						<td class="text_right"><span class="required">*</span>产品产量</td>
						<td class="content_left"><input type="text"
							id="text_output_num" name="text_output_num" value="${pamodel.productNum}"/></td>
					</tr>
					<tr>
						<td class="text_right"><span class="required">*</span>手机</td>
						<td class="content_left"><input type="text"
							id="text_contact_phone" name="text_contact_phone" value="${pamodel.constract}"/></td>
						<td class="text_right"><span class="required">*</span>申请标签数量</td>
						<td class="content_left"><input type="text"
							id="text_label_num" name="text_label_num" value="${pamodel.labelNum}"/></td>
					</tr>
					<tr>
						...
						<td class="content_left"><textarea
								...
								name="text_product_desc">${pamodel.originDescription }</textarea></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div style="width: 100%; height: 30px; line-height: 30px; background: #0090d7; padding-left: 10px; margin-top: 10dp; margin-right: 10dp">
		...
		<div style="float: block; height: auto">
			<div id="imgContainer" style="height: 150px; width: auto">
			</div>
			<table width="300px">
			<tr>
				...
				<tr>
					...
					<td><input onfocus="WdatePicker({readOnly:true,maxDate:'%y-%M-%d'})" type="text" id="input_publish_time"/></td>
				</tr>
		...
		<input class="btn_blue"
				type="button" style="width: 100px; height: 30px" value="提交"
				onclick="validate()" />
