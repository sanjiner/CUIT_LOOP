...
<div style="background: #4c9ee7;width: 100%;height: 30px;margin-bottom: 5px">
	<label style="width: auto;height: 30px;text-align: center;color: white;line-height: 30px;margin-left: 5px">应用中心>>项目归档>>归档详情</label>
</div>
<br/>
...
<div id="div00" style="background-color: #FFFFFF">
	<div style="width: 100%; height: 50px;background: #8cbeef;text-align: left;">
		<label style="margin-left: 10px;text-align: center;position:relative; top:25%;"><font size="+1.5px">归档信息</font></label>
	</div>
	<div>
		<table>	
			<tr>
