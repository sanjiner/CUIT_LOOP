...
<body>
		...
		<div>
			<span>第<font color="red">${applyPage.currentPage}</font>页/共<font
				...
				color="red">${applyPage.allSize}</font>条记录
					...
					href="<%=basePath%>/infom/ExpertsGroup?requsetPageNo=${applyPage.prePage}">上一页</a></span>
				<span><a
					href="<%=basePath%>/infom/ExpertsGroup?requsetPageNo=${applyPage.nextPage}">下一页</a></span>
  ...
  function print(){   
    ...
    var c="<%=basePath%>infom/ExpertsGroup?requsetPageNo="
