 ...
 */
public class PullListView extends OuterListView implements OnScrollListener {
	...
	private OnPullListViewListener mListViewListener;
...
//			});
	...
	private void startLoadMore() {
		...
		if (mListViewListener != null) {
			//开始下载数据
			mListViewListener.onPullLoadMore(this);
		}
	}
		...
		case MotionEvent.ACTION_UP:
			...
			if (getFirstVisiblePosition() == 0) {
				...
				if (mEnablePullRefresh && mHeaderView.getVisiableHeight() >= mHeaderViewHeight) {
					...
					if (mListViewListener != null) {
						//刷新
						mListViewListener.onPullRefresh(this);
					}
				}
	 ...
	 */
	public void setOnPullListViewListener(OnPullListViewListener listViewListener) {
		mListViewListener = listViewListener;
		mPullRefreshing = true;
		mHeaderView.setState(ScrollViewHeader.STATE_REFRESHING);
		if (mListViewListener != null) mListViewListener.onPullRefresh(this);
