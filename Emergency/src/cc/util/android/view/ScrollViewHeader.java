 ...
 */
public class ScrollViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		//从包里获取的箭头图片
		arrowImage = BitmapFactory.decodeStream(ScrollViewHeader.class.getResourceAsStream("image/arrow_black.png"));
		...
		layoutParamsWW.width = 30;
		layoutParamsWW.height = 30;
		...
		headerTimeView.setTextColor(Color.WHITE);
		...
		switch(state){
			case STATE_NORMAL:
				...
				if(lastRefreshTime==null){
					lastRefreshTime = dateFormat.format(new Date());
