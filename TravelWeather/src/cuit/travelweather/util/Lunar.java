...
public final class Lunar {
	...
	public static String getLunar(String year, String month, String day) {
		...
		Lunar1(sDObj); // 农历
		/*
		 * s = "农历 " + "【" + Animals[sy] + "】" + cYear(getYear()) + "年" + " "; s
		 * += (getIsLeap() ? "闰" : "") + monthNong[getMonth()] + "月" +
		 * (monthDays(getYear(), getMonth()) == 29 ? "小" : "大"); s +=
		 * cDay(getDay()) + " "; s += cyclical(getYearCyl()) + "年" +
		 * cyclical(getMonCyl()) + "月" + cyclical(getDayCyl()) + "日";
		 */
		s = "农历" + " " + cYear(getYear()) + "年";
	...
	public static void main(String[] args) {
		...
		System.out.println(getLunar("2014", "1", "2"));
	}
}