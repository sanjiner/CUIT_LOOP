...
@SuppressLint("NewApi")
public class Comment4ShopActivity extends BaseAct {
	
	private Context context = Comment4ShopActivity.this;
	...
	private void initViews() {
		...
		TextView tv1 = (TextView)findViewById(R.id.comm);
		 sp= getSharedPreferences("test", Activity.MODE_PRIVATE); 
		 String size = sp.getString("affairinfo_fontsize", "2");
		if(size.equals("1")){
			tv1.setTextSize(10);
			btn_comment_addBtn.setTextSize(10);
		}else if(size.equals("2")){
		}else{
			tv1.setTextSize(30);
			btn_comment_addBtn.setTextSize(30);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_comment4_shop);
		initViews();
