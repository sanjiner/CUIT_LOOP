...
public class FollowList extends FakeActivity implements OnClickListener,
	...
	private static class FollowAdapter extends BaseAdapter implements
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				...
				int dp_15 = cn.sharesdk.framework.utils.R.dipToPx(
						parent.getContext(), 15);
			...
			ivCheck.setImageResource(following.checked ? R.drawable.auth_follow_cb_chd
					: R.drawable.auth_follow_cb_unc);
