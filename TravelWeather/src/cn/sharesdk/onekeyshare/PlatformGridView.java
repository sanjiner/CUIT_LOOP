 ...
 * 平台宫格列表显示工具。
 * <p>
 * PlatformGridView对“android.support”包有依赖，因此请注意检查您项目中是 否已经集成了相应的jar包
 */
public class PlatformGridView extends LinearLayout implements
	...
	public void afterPlatformListGot() {
		...
		grayPoint = BitmapFactory.decodeResource(getResources(),
				R.drawable.gray_point);
		whitePoint = BitmapFactory.decodeResource(getResources(),
