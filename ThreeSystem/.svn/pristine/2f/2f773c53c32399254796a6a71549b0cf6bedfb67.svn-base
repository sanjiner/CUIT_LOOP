...
public class DownrefreshListView2 extends ListView implements OnScrollListener{
    ...
    public DownrefreshListView2(Context context) {  
        super(context);  
//        init(context);  
    }  
  
    public DownrefreshListView2(Context context, AttributeSet attrs) {  
        super(context, attrs);  
//        init(context);  
    }  
