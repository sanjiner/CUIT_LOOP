...
public class TeacherThesisDefenseTeamscoreActivity_studentlist  extends BaseActivity implements OnClickListener,
OnItemClickListener{
	...
	private void getStudentList(){
		teacherID= shared_Pref.getString(Constant.SPFIELD.TEACHERID, "");
		String teachername=shared_Pref.getString(Constant.SPFIELD.NAME, "");
		Map<String, String> params =new HashMap<String, String>();
		params.put("teacherID", teacherID);
		params.put("teacherName", teachername);
		String url = URLTools.buildURL(Constant.THESIS_BASEURL+"TeamStudent", params);
	...
	public void onItemClick(AdapterView<?>parent, View view, int position,
		...
		Intent intent = new Intent(mActivity, TeacherThesisDefenseTeamscoreActivity_getscoreDetail.class);
