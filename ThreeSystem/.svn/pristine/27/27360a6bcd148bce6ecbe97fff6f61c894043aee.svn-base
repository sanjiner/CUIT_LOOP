...
import com.example.theses.fragments.Thesis_StudentHome_Fragment;

public class Thesis_StudentMainActivity extends BaseActivity implements OnCheckedChangeListener{
	...
	private void initFragment()
	{
		...
		fragments = new Fragment[]{new Thesis_StudentHome_Fragment(),
