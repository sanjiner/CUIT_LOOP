...
public class ProcessModifyPwdActivity extends BaseActivity implements OnClickListener {
	...
	private String BASE_URL = Constant.PROCESS_BASUURL;
	private String NOW_URL = "";
	
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_process_modifypwd);
	...
	private void getViewObj() {
		more_modifyPwd_userId = (TextView)findViewById(R.id.process_more_modifyPwd_currentUserId);
		more_modifyPwd_userName = (TextView)findViewById(R.id.process_more_modifyPwd_currentUserName);
		
		more_modifyPwd_oldPwd = (EditText)findViewById(R.id.process_more_modifyPwd_currentUser_oldPwd);
		more_modifyPwd_newPwd = (EditText)findViewById(R.id.process_more_modifyPwd_currentUser_newPwd);
		more_modifyPwd_comfirmNewPwd = (EditText)findViewById(R.id.process_more_modifyPwd_currentUser_confireNewPwd);
		progressbar = (ProgressBar)findViewById(R.id.process_more_ModifyPwd_progressbar);
		more_modifyPwd_submit = (Button)findViewById(R.id.process_more_modifyPwd_submit);
		more_mdofyPwd_back = (Button)findViewById(R.id.process_more_modifypwd_back);
	}
	...
	public void onClick(View v) {
		switch(v.getId()){
		case R.id.process_more_modifyPwd_submit:
				submit();
			break;
		case R.id.process_more_modifypwd_back:
			finish();
			break;
		}
	}
	...
	private void StudentUrl() {
		NOW_URL = BASE_URL + "ResetPassWord?StuNumber=" + more_modifyPwd_userId.getText().toString()
				+ "&newPassWord=" + MD5ENCODE.MD5Encode(more_modifyPwd_newPwd.getText().toString()).toString() + "";
	}
