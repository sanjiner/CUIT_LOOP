...
public class Thesis_Project_Management_ListAdapter extends BaseAdapter {

	Context context;
	public  List<Map<String, String>> data;
	
	public Thesis_Project_Management_ListAdapter(Context context, List<Map<String, String>> data)
	{
