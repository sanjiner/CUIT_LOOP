...
public class Thesis_StudentHome_OpenReportActivity extends BaseActivity implements OnClickListener{
	private TextView Title, Background, Thought, Progress,GuidanceTeacherIdea,GuidenceTeacherCheckTime,GuidanceTeacherSign, err;
	...
	private void initView() {
		...
		GuidanceTeacherIdea =(TextView)findViewById(R.id.thesis_StudentHome_OpenReport_GuidanceTeacherIdea);
		GuidenceTeacherCheckTime =(TextView)findViewById(R.id.thesis_StudentHome_OpenReport_GuidenceTeacherCheckTime);
		GuidanceTeacherSign = (TextView)findViewById(R.id.thesis_StudentHome_OpenReport_GuidanceTeacherSign);
				...
				if(!response.isEmpty()){
					try {
						...
						if(jsonobject.getString("success").equals("true")){
							...
							GuidanceTeacherIdea.setText(jsonobject.getString("GuidanceTeacherIdea").toString());
							GuidenceTeacherCheckTime.setText(jsonobject.getString("GuidenceTeacherCheckTime").toString());
							GuidanceTeacherSign.setText(jsonobject.getString("GuidanceTeacherSign").toString());
