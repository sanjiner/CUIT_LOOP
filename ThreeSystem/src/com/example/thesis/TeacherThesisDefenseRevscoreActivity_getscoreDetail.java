...
public class TeacherThesisDefenseRevscoreActivity_getscoreDetail extends BaseActivity implements OnClickListener{
	...
	public void submitScore(){
		...
		if (TextUtils.isEmpty(qualityScore) || TextUtils.isEmpty(processScore)
			...
			String url = URLTools.buildURL(Constant.THESIS_BASEURL + "RevEdit", params);
