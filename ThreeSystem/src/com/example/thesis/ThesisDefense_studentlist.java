...
public class ThesisDefense_studentlist  extends BaseActivity implements OnClickListener,
OnItemClickListener{
	...
	public void onItemClick(AdapterView<?>parent, View view, int position,
		...
		Intent intent = new Intent(mActivity, ThisesDefense_getscoreDetail.class);
