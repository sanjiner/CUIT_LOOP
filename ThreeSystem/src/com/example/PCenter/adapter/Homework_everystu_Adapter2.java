...
public class Homework_everystu_Adapter2 extends BaseAdapter{
...
//	public static String StuAnswer;
	...
	public Homework_everystu_Adapter2(Context context, List<Map<String, String>> data) {
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			...
			holder.StuNumber=(TextView) convertView.findViewById(R.id.tv_more_class_id2);
