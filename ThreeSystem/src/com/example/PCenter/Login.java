...
import com.example.process.MainActivityProcess;
...
public class Login extends BaseActivity implements OnClickListener{
	...
	private String process_BASEURL = Constant.PROCESS_BASUURL;
        ...
        try {
            ...
            while (true) {
                ...
                if (null != message) {
                    ...
                    T.showShort(mActivity, message.getText());
                } else {
                    break;
                }
            }
		...
		if(TextUtils.isEmpty(userName)|| TextUtils.isEmpty(passWord)){
			...
			if(userIdentity.equals("老师")){
				...
				if(system.equals("教学辅助")){
					...
					NOW_URL = process_BASEURL + "StuLogin?StuNumber=" + userName.toString()
					+ "&StuPasswd=" + MD5ENCODE.MD5Encode(passWord).toString() + "";
		}
			}
		}
		...
		return new Listener<String>() {
			...
			public void onResponse(String response) {
				try {
					...
					{
						String realname=null, sex, classname = null, majorname, departmentname = null;
						
						if(userIdentity.equalsIgnoreCase("老师")){
							if(system.equals("毕业论文"))
							{
								Editor edit = sp.edit();
